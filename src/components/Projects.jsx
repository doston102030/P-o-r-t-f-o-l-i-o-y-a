                ...
                <div className="project-image-wrapper">
                  ...
                  <div className="project-hover-overlay">
                    <div className="project-hover-content">
                      <h4 className="project-hover-title">{p.title}</h4>
                      <div className="project-hover-actions">
                        <a href={p.demo} target="_blank" rel="noreferrer" className="hover-btn hover-btn--demo">
                          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                            <circle cx="12" cy="12" r="10" /><polygon points="10 8 16 12 10 16 10 8" />
                          </svg>
                          Demo
                        </a>
                        <a href={p.github} target="_blank" rel="noreferrer" className="hover-btn hover-btn--github">
