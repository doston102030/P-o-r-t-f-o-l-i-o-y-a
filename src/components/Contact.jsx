...
export default function Contact() {
  ...
  const socialLinks = [
    {
      name: 'Telegram',
      href: fsData?.telegram || 'https://t.me/adhamjonov_doston',
      color: '#26A5E4',
    ...
    {
      name: 'Instagram',
      href: fsData?.instagram || 'https://instagram.com/adhamjonov_doston',
      color: '#E1306C',
    ...
    {
      name: 'LinkedIn',
      href: fsData?.linkedin || 'https://linkedin.com/in/adhamjonov-doston',
      color: '#0A66C2',
    ...
    {
      name: 'GitHub',
      href: fsData?.github || 'https://github.com/adhamjonov-doston',
      color: '#ffffff',
