...
const socialLinks = [
  {
    name: 'Telegram', href: 'https://t.me/abdumajid',
  ...
  {
    name: 'Instagram', href: 'https://instagram.com/abdumajid',
    ...
    <footer className="footer">
      ...
      <div className="container footer-container">
        ...
        <div className="footer-socials">
          {socialLinks.map(s => (
            <a key={s.name} href={s.href} target="_blank" rel="noreferrer" className="footer-social-btn" title={s.name}>{s.icon}</a>
          ))}
        </div>
      </div>
